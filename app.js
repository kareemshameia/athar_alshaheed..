...
const PRAYERS = [
  ...
  { text:"اللهم ارحم الشهيد عبد الرحمن محيسن وأكرم نزله، ووسع مدخله، واغسله بالماء والثلج والبرد. اللهم أنزله منازل الصديقين والشهداء والصالحين وحسن أولئك رفيقا، واجعل قبره روضة من رياض الجنة، وألهم أهله وذويه الصبر والسلوان.", cat:"أدعية طويلة" },
...
function renderSettings() {
  ...
  return `<div class="page">
    ...
    <div class="scroll-body">
      ...
      <!-- Developer credit -->
      <div class="clay" style="padding:.85rem 1.25rem;margin-bottom:2rem;text-align:center;background:linear-gradient(135deg,rgba(126,87,194,.08),rgba(255,183,77,.06));border:1px solid rgba(126,87,194,.15);">
        <div style="font-size:.72rem;color:var(--text-lt);margin-bottom:.2rem;">💻 تم التطوير بواسطة</div>
        <div style="font-weight:800;color:var(--purple);font-size:.95rem;">كريم شامية</div>
      </div>
    </div>
  </div>`;
}
